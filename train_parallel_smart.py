...
from model import BERTLinearModel,BERTLinearModel_NER, BERTLinearModel_SA, SmartRobertaModel_SA, SmartRobertaModel_NER
import argparse
import os
from torch.utils.tensorboard import SummaryWriter
from adv_train import FGM, PGD
...
torch.cuda.set_device('cuda:{}'.format(os.environ['LOCAL_RANK']))
...
train_dl = DataLoader(train_data, batch_size= batch_size,collate_fn=collate_func_train,sampler=train_sampler)
...
model = nn.parallel.DistributedDataParallel(model.cuda(), device_ids=[device_id], output_device=device_id)
best_dev_score = 0
