...
from model import BERTLinearModel, BERTLinearModel_SA, BERTLinearModel_NER, SmartRobertaModel_SA, SmartRobertaModel_NER
import argparse
import os
...
data_path1 = '/home/zoulexiao/workspace/nlp_contest/data/train_data_public_1.csv'
data_path2 = '/home/zoulexiao/workspace/nlp_contest/data/train_data_public_2.csv'
data_path3 = '/home/zoulexiao/workspace/nlp_contest/data/train_data_public_3.csv'
data_path4 = '/home/zoulexiao/workspace/nlp_contest/data/train_data_public_4.csv'
data1 = pd.read_csv(data_path1)
data2 = pd.read_csv(data_path2)
data3 = pd.read_csv(data_path3)
data4 = pd.read_csv(data_path4)
train = pd.concat([data2, data3, data4], axis=0)
dev = data1
...
#               'hlf/rbtl3']
args = parse()
writer = SummaryWriter('/home/zoulexiao/workspace/nlp_contest/log/'+ args.question + '_' +args.experiment_name)
...
set_seed(seed)
# load data
train_data = BankDateset(tokenizer, max_len, "train",dataframe=train)
dev_data = BankDateset(tokenizer, max_len, "train",dataframe=dev)
        ...
        with torch.no_grad():
            ...
            if question == 'NER':
                ...
                ner_logits = test_model(input_ids = input_ids,
                                        ...
                                        mode = 'test')
                ner_logits = ner_logits.view(-1, max_len, num_labels)
...
if args.question == 'NER':
    model = SmartRobertaModel_NER(model_name,hidden_size, num_labels, args.dropout)
else:
    model = SmartRobertaModel_SA(model_name,hidden_size, num_classes, args.dropout)
...
for i in trange(0, int(epoch), desc="Epoch", disable=False):
    ...
    writer.add_scalar('dev_score', score, i)
