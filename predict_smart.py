...
if __name__ == "__main__":
    ...
    version = 'ls_smart_mac'
    model_name = 'hfl/chinese-macbert-large'
    hidden_size = 1024
    num_classes = 3
    #model_SA = torch.load('/home/zoulexiao/workspace/nlp_contest/experiment/SA/' + model_name +'.pth')
    state_dict = torch.load("/home/zoulexiao/workspace/nlp_contest/experiment/SA/smart_ls_chinese-macbert-large.pth", map_location=torch.device('cuda'))
