    ...
    for batch in data_loader:
        with torch.no_grad():
            ...
            sa_logits = test_model_SA(input_ids = input_ids,
                                        ...
                                        position_ids = position_ids,
                                        mode = 'test')
            ner_logits = ner_logits.view(-1, 100, 9)
...
def give_result(model_SA, model_NER, device, tokenizer, save_path):
    ...
    max_len = 100
    test_data = BankDateset(tokenizer, max_len, "test",file_path=test_path)
    result = []
...
if __name__ == "__main__":
    ...
    model_SA = torch.load("/home/zoulexiao/workspace/nlp_contest/experiment/SA/4_smart_chinese-macbert-large.pth")
    ...
    model_NER = torch.load('/home/zoulexiao/workspace/nlp_contest/experiment/NER/smart_chinese-macbert-large.pth')
